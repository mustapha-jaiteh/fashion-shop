...
const Carousel = ({ products }: Props) => {
  ...
  return (
    <Card className="relative overflow-hidden rounded-lg shadow-md border-gray-300  h-[600px] mx-2 my-16">
      ...
      <CardContent className="absolute inset-0 flex flex-col items-center justify-center bg-black bg-opacity-50 p-4">
        <div className=" bg-neutral-700 p-4 rounded-lg flex flex-col items-center justify-center">
          <CardTitle className="tex-2xl md:text-4xl font-bold text-white mb-6">
            {currentProduct.name}
          </CardTitle>
